...
import { KIT_REVIT_PLUGIN_STATUS_VALIDATOR } from './revit-plugin.js';

describe('KIT_REVIT_PLUGIN_STATUS_VALIDATOR', (): void => {
  type TestCase = {
  ...
  it.each<TestCase>([
    ...
    expect(
      KIT_REVIT_PLUGIN_STATUS_VALIDATOR.parse(data.input),
