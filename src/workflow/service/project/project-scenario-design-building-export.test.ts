...
import { PROJECT_SCENARIO_DESIGN_BUILDING_EXPORT_STATUS } from './project-scenario-design-building-export.js';

describe('PROJECT_SCENARIO_DESIGN_BUILDING_EXPORT_STATUS', (): void => {
  type TestCase = {
  ...
  it.each<TestCase>([
    ...
    expect(
      PROJECT_SCENARIO_DESIGN_BUILDING_EXPORT_STATUS.parse(data.input),
